public class Test {
    public static void main(String[] args) {
        String[] wordLisOne = {"24/7", "multi-Tier", "30,000 foot", "B-to-B", "win-win", "front-end", "web-based", "pervasive", "smart",
        ...
        String phrase = wordLisOne[rand1] + "" + wordListTwo[rand2] + "" + wordListThree[rand3];
